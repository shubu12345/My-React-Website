    ...
    <div className="work-section">
      <div className="project project-1">
        <div className="project-details">
          ...
          <p>
            This Expense Tracker App, built with React, HTML, CSS, JavaScript,
            Bootstrap, and MongoDB, allows users to add, edit, and delete tasks.
            It uses MongoDB for persistent data storage and features a
          ...
          <div style={{ marginTop: 25 }}>
            <a
              ...
              href="https://track-finance-today.netlify.app/"
              target="_blank"
              rel="noreferrer"
            >
              <span
